 ...
 * @path        Modules/TenantManagement/Controllers/TenantController.php
...
use Modules\TenantManagement\Requests\StoreTenantRequest;
use Modules\TenantManagement\Requests\UpdateTenantSuspensionRequest;
